...
def PoderW(mx,largura,my,px,py,poder):
    match poder:
        ...
        case 1:
            loc = ((round((mx/(largura/8))-0.5) == px+1 or round((mx/(largura/8))-0.5) == px-1) and ((round((my/(largura/8))-0.5) == py-3))) or ((round((mx/(largura/8))-0.5) == px+3 or round((mx/(largura/8))-0.5) == px-3) and ((round((my/(largura/8))-0.5) == py-1))) or ((round((mx/(largura/8))-0.5) == px+1 or round((mx/(largura/8))-0.5) == px-1) and ((round((my/(largura/8))-0.5) == py+3))) or ((round((mx/(largura/8))-0.5) == px+3 or round((mx/(largura/8))-0.5) == px-3) and ((round((my/(largura/8))-0.5) == py+1)))
